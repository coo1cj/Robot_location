...
df_lidar = pd.read_csv('scenario_3\scan.csv', sep=',')      #### changer le numero de scenario
...
df_encoder = pd.read_csv('scenario_3\sensor_state.csv', sep=',')  #### changer le numero de scenario
r = 0.033
L = 0.08
...
#### centrale ineritelle
df_imu = pd.read_csv('scenario_3\imu.csv', sep=',') ### changer le numero de scenario
